...
let AboutInfoComponent = class AboutInfoComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let AdminInfoComponent = class AdminInfoComponent {
    constructor(sanitizer, adminInfoService) {
    ...
    ngOnInit() {
        ...
        this.adminInfoService.getProductsInfo(obj.agencyId, obj.agencyName).subscribe({
            next: products => {
                this.packageCoutInfo = products.packageList;
            },
    ...
    onSelectFile(event) {
        ...
        if (event.target.files && event.target.files[0]) {
            ...
            reader.onload = (event) => {
                ...
                this.uploadImageData(this.fileNameUrl, this.urlData);
            };
        }
    }
    uploadImageData(fileName, encodedValue) {
        ...
        this.adminInfoService.uploadImageFile(req).subscribe({
            next: products => {
                let productResp = products.imageList;
                // console.log('productResp'+productResp)
                if (productResp.length > 0) {
                    let imageList = productResp[0];
                    // console.log(imageList);
                    this.urlData = imageList.imageUrl;
                    this.isSummeryImageLoading = false;
    ...
    updateImageDetailsView(data) {
        if (!this.isManualyFileCahge) {
            this.detailsURLData = data;
        }
    }
    onSelectDetailsFile(event) {
        ...
        if (event.target.files && event.target.files[0]) {
            ...
            reader.onload = (event) => {
                console.log(event);
                this.detailsURLData = reader.result; //add source to image
                // console.log('url---'+this.urlData)
                this.uploadDetailsImageData(fileName, this.detailsURLData);
            };
        }
    }
    uploadDetailsImageData(fileName, encodedValue) {
        ...
        this.adminInfoService.uploadImageFile(req).subscribe({
            next: products => {
                ...
                if (productResp.length > 0) {
                    let imageList = productResp[0];
                    // console.log(imageList);
                    this.detailsURLData = imageList.imageUrl;
                    this.isDetaisImageLoading = false;
                }
                this.isDetaisImageLoading = false;
            },
                    ...
                    this.adminInfoService.uploadImageFile(req).subscribe({
                        next: products => {
                            ...
                            if (productResp.length > 0) {
                                let imageList = productResp[0];
                                // console.log(imageList);
                                this.dayWiseList[index].images[0] = imageList.imageUrl;
                                this.ismageLoading[index] = false;
                            }
                        },
                        error: err => this.errorMessage = err
                    });
    ...
    addDetailsInfo(headingData, descriptionData, index) {
    ...
    saveSummeryView() {
        ...
        this.adminInfoService.updateProducts(requestInfo).subscribe({
            next: products => {
                let productResp = products.packageDetailsRS;
                this.packageId = productResp.packageId;
                this.isSummeryVSaveLoading = false;
...
AdminInfoComponent.ctorParameters = () => [
...
let AdminInfoService = class AdminInfoService {
    constructor(http) {
        this.http = http;
        this._baseURL = src_app_common_AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].apiURL;
    }
    updateProducts(requestData) {
        let url = this._baseURL + 'SearchDetails/updateProductInfo';
        return this.http.post(url, requestData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(data => { console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
    }
    getProductsInfo(agencyId, agencyName) {
        let url = this._baseURL + 'ActionService/allPackageOverview';
        let req = {
            agencyId: agencyId,
    ...
    getProductInfoDetails(request) {
        let url = this._baseURL + 'ActionService/packageInfoDetails';
        return this.http.post(url, request)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(data => { console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
    }
    uploadImageFile(request) {
        let url = this._baseURL + 'ImageService/imageUpload';
        return this.http.post(url, request)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(data => { console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
    }
    handleError(err) {
...
AdminInfoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let AllpackageInfoComponent = class AllpackageInfoComponent {
    constructor(summary, actionInfoService) {
...
AllpackageInfoComponent.ctorParameters = () => [
...
let ActionInfoService = class ActionInfoService {
    constructor(http) {
        this.http = http;
        this._baseURL = src_app_common_AppConstants__WEBPACK_IMPORTED_MODULE_5__["AppConstants"].apiURL;
    }
    getAllActionDetails(requestData) {
        let url = this._baseURL + 'ActionService/allActionInfo';
        return this.http.post(url, requestData)
    ...
    getInCompleateDetails(requestData) {
        let url = this._baseURL + 'ActionService/inCompleateInfo';
        return this.http.post(url, requestData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => { console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getInActiveDetails(requestData) {
        let url = this._baseURL + 'ActionService/inActiveInfo';
        return this.http.post(url, requestData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => { console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    modifyCompleateDetails(requestData) {
        let url = this._baseURL + 'ActionService/upadatePackageActionInfo';
        return this.http.post(url, requestData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => { console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    handleError(err) {
...
ActionInfoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let InactiveInfoComponent = class InactiveInfoComponent {
    constructor(summary, actionInfoService) {
        this.summary = summary;
        this.actionInfoService = actionInfoService;
        this.loading = true;
...
InactiveInfoComponent.ctorParameters = () => [
    { type: src_app_product_summary_info_summary_info_service__WEBPACK_IMPORTED_MODULE_2__["SummaryInfoService"] },
...
let IncompleateInfoComponent = class IncompleateInfoComponent {
    constructor(summary, actionInfoService) {
        this.summary = summary;
        this.actionInfoService = actionInfoService;
        this.loading = true;
...
IncompleateInfoComponent.ctorParameters = () => [
    { type: src_app_product_summary_info_summary_info_service__WEBPACK_IMPORTED_MODULE_2__["SummaryInfoService"] },
    { type: _inactive_info_action_info_service__WEBPACK_IMPORTED_MODULE_3__["ActionInfoService"] }
];
...
let FooterInfoComponent = class FooterInfoComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let HederInfoComponent = class HederInfoComponent {
    ...
    constructor(authService, loginService, router, logoutInfoComponent) {
        ...
        this.subscription = this.logoutInfoComponent.getName().subscribe((message) => {
...
HederInfoComponent.ctorParameters = () => [
...
let HomeInfoComponent = class HomeInfoComponent {
    constructor() {
        ...
        this.authenticationService.loginValidate(userName, password).subscribe({
            ...
            error: err => {
                ...
                if ('ADMIN' == userName.toLocaleUpperCase() && 'ADMIN@123' == password.toLocaleUpperCase()) {
                    ...
                    sessionStorage.setItem('sessionUser', JSON.stringify(this.userResponse));
                    this.router.navigate(['admin']);
                }
                else {
                    this.getErrorUpdate();
...
let LogoutInfoComponent = class LogoutInfoComponent {
    constructor() {
...
let PackageInfoComponent = class PackageInfoComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let DetailsPageComponent = class DetailsPageComponent {
    constructor(route, router, pageService) {
        this.route = route;
        this.router = router;
...
let DetailsPageService = class DetailsPageService {
    constructor(http) {
        this.http = http;
        this._baseURL = src_app_common_AppConstants__WEBPACK_IMPORTED_MODULE_5__["AppConstants"].apiURL;
    }
    getProducts(id) {
        ...
        let url = this._baseURL + 'SearchDetails/detailsInfo/' + id;
...
DetailsPageService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let EditPackageComponent = class EditPackageComponent {
    constructor(route, router, adminInfoService) {
        this.route = route;
        this.router = router;
        this.adminInfoService = adminInfoService;
        this.isSuccesFullSave = false;
    ...
    ngOnInit() {
        ...
        this.adminInfoService.getProductInfoDetails(request).subscribe({
            next: products => {
                this.loading = false;
                let response = products.packageDetailsRS;
                try {
                    this.agencyName = response.agencyName;
                    this.agencyReview = response.agencyReview;
                    this.packageId = response.packageId;
                    this.packageName = response.packageName;
                    console.log('response.packageName : ' + this.packageName);
                    this.originalPrice = response.originalPrice;
                    this.offerPrice = response.offerPrice;
                    this.noOfDays = response.noOfDays;
                    this.noOfNights = response.noOfNights;
                    if (response.tripPlaces) {
                        this.tripPlaces = response.tripPlaces;
                    }
                    if (response.amenities != null) {
                        this.setAmenitiesList(response.amenities);
                    }
                    if (response.packageCategory != null) {
                        this.setPackageCategory(response.packageCategory);
                    }
                    this.currency = response.currency;
                    this.setHightLightData(response.highlights);
                    this.setoverviewData(response.overview);
                    if (response.dayWiseList != null && response.dayWiseList.length > 0) {
                        this.dayWiseList = response.dayWiseList;
                    }
                    this.urlData = response.images[0];
                    if (response.overviewImages != null) {
                        this.detailsURLData = response.overviewImages[0];
                    }
                    else {
                        this.detailsURLData = response.images[0];
                    }
                }
                catch (error) {
                    console.log(error);
    ...
    setAmenitiesMap() {
        for (let index = 0; index < this.amenityList.length; index++) {
            let element = this.amenityList[index];
            this.amenitiesMap.set(element.name, index);
        }
    }
    setAmenitiesList(amenitiesList) {
        this.setAmenitiesMap();
        amenitiesList.forEach(elementStr => {
            let id = this.amenitiesMap.get(elementStr);
            if (id) {
                this.aminitiesCheck[id] = true;
            }
            else {
                for (let index = 0; index < this.amenityList.length; index++) {
                    const element = this.amenityList[index];
    ...
    setpackageTypeMap() {
        for (let index = 0; index < this.packageType.length; index++) {
            let element = this.packageType[index];
            this.packageTypeMap.set(element, index);
        }
    }
    setPackageCategory(packageList) {
        this.setpackageTypeMap();
        packageList.forEach(element => {
            let ind = this.packageTypeMap.get(element);
            if (ind) {
                this.packageTypeSelcted[ind] = true;
            }
            else {
                for (let index = 0; index < this.packageType.length; index++) {
                    const elementStr = this.packageType[index];
                    if (element.toLocaleLowerCase() == elementStr.toLocaleLowerCase()) {
                        this.packageTypeSelcted[index] = true;
                        break;
                    }
                }
            }
    ...
    setHightLightData(highlightdata) {
    ...
    saveSummeryView() {
        this.isSummeryVSaveLoading = true;
        let high = this.highlights.split(/\n/g);
        let request = {
            "agencyId": this.agencyId,
            "agencyName": this.agencyName,
            "agencyReview": this.agencyReview,
...
EditPackageComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let SummaryInfoComponent = class SummaryInfoComponent {
    constructor(summary) {
        this.summary = summary;
        this.productArr = [];
        this.loading = true;
    ...
    get destinationsName1() {
        return this._destinationsName1;
    }
    set destinationsName1(value) {
    ...
    ngOnInit() {
        ...
        // setTimeout(function(){
        try {
            let isFirstTime = localStorage.getItem('isAlreay');
    ...
    performfilter(filterBy) {
        ...
        return this.productResponse.filter((product) => product.packageName.toLocaleLowerCase().indexOf(filterBy) != -1
            || product.tripPlaces.toString().toLocaleLowerCase().indexOf(filterBy) != -1);
    }
};
SummaryInfoComponent.ctorParameters = () => [
...
let SummaryInfoService = class SummaryInfoService {
    constructor(http) {
        this.http = http;
        this._baseURL = src_app_common_AppConstants__WEBPACK_IMPORTED_MODULE_5__["AppConstants"].apiURL;
    }
    ...
    getSearchProducts(city, date) {
        // let url ='assets/api/summery/summery1.json'
        let url = this._baseURL + 'SearchService/searchSummeryInfo/' + city;
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => { console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getDummyProducts() {
        let url = 'assets/api/summery/summery.json';
        // let url =this._baseURL+ 'SearchService/summeryInfo'
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => { console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getBookerDetails(request) {
        // let url ='assets/api/summery/summery1.json'
        let url = this._baseURL + 'ActionService/bookerDetails';
        return this.http.post(url, request)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => { console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    handleError(err) {
...
SummaryInfoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let TourPackagesComponent = class TourPackagesComponent {
    constructor(route, summary) {
        this.route = route;
        this.summary = summary;
        this.placeName = '';
        this.loading = true;
    ...
    ngOnInit() {
        let city = this.route.snapshot.paramMap.get('name');
        this.placeName = city;
        // this.buttonLoader = true;
        console.log("getSummeryData########city#########--" + city);
        // console.log('-----------date*************'+date);
        ...
        this.summary.getProducts().subscribe({
            next: products => {
                this.response = products;
                // this.productArr = this.response.packageSummeryRS;
                this.productResponse = this.response.packageSummeryRS;
                let value = this.performfilter(city);
                console.log(value);
                this.productArr = value.length > 0 ? value : this.productResponse;
                this.loading = false;
                // this.buttonLoader = false;
                // this.filteredProducts = this.products;
            },
...
TourPackagesComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
let ProfileInfoComponent = class ProfileInfoComponent {
    constructor(router, authenticationService, adminInfoService) {
        this.router = router;
        this.authenticationService = authenticationService;
        this.adminInfoService = adminInfoService;
        this.userName = 'Profile';
        ...
        this.authenticationService.profileIinfo(Req).subscribe({
            next: products => {
                ...
                if (products.profileUrl) {
                    this.imagePath = products.profileUrl;
                }
                this.loading = false;
            },
            error: err => this.errorMessage = err
    ...
    onSelectFile(event) {
        ...
        if (event.target.files && event.target.files[0]) {
            ...
            // console.log('imagePath' + this.imagePath);
            reader.readAsDataURL(event.target.files[0]); // read file as data url
            let fileNameUrl = event.target.files[0].name;
            reader.onload = (event) => {
                console.log(event);
                this.imagePath = reader.result; //add source to image
        ...
        this.adminInfoService.uploadImageFile(req).subscribe({
            next: products => {
                ...
                if (productResp.length > 0) {
                    let imageList = productResp[0];
                    // console.log(imageList);
                    this.imagePath = imageList.imageUrl;
                    // this.isSummeryImageLoading = false;
                    // this.updateImageDetailsView(this.urlData);
                }
            },
...
let RecentTripInfoComponent = class RecentTripInfoComponent {
    constructor() {
        this.name = 'Angular';
    }
    ngOnInit() {
...
let RecentTripComponent = class RecentTripComponent {
    constructor() { }
    // declare var $ : any;
    ngOnInit() {
...
let BookerInfoComponent = class BookerInfoComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let LoadingInfoComponent = class LoadingInfoComponent {
    constructor() {
        this.earthIng = 'assets/images/logo/earth.png';
        this.moonIng = 'assets/images/logo/moon.png';
    }
...
let SummeryViewComponent = class SummeryViewComponent {
    // productArr =[];
    constructor(summaryInfoService) {
...
SummeryViewComponent.ctorParameters = () => [
    { type: src_app_product_summary_info_summary_info_service__WEBPACK_IMPORTED_MODULE_2__["SummaryInfoService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        if (allOk) {
            ...
            this.authenticationService.userRegistration(request).subscribe({
                next: products => {
                    ...
                    let isValid = response.isValidUser;
                    ...
                    if (isValid == 'true') {
                        ...
                        if (er) {
                            this.errorFullMessage(er);
                        }
                        else {
                            this.errorFullMessage('Unable to create user Please provide currect info ....');
                        }
                    }
                    this.isLoading = false;
                },
                error: err => {
                    this.isLoading = false;
                    this.errorFullMessage('Unable to create user ......');
                }
            });
        }
        else {
...
SignUpInfoComponent.ctorParameters = () => [
...
let WelcomeInfoComponent = class WelcomeInfoComponent {
    constructor() {
        this.isParentDivActive = false;
    }
    ngOnInit() {
